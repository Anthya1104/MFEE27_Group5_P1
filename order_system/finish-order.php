...
// 先sql總共有多少筆資料
$sqlAll = "SELECT * FROM user_order WHERE valid=1 AND status = 3";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="py-2">
                <ul class="pagination">
                    <?php for ($i = 1; $i <= 2; $i++) : ?>
                        <li class="page-item <?php if ($page == $i) echo "active"; ?>"><a class="page-link" href="finish-order.php?page=<?= $i ?>"><?= $i ?></a></li>
                    <?php endfor; ?>
                </ul>
            </div>
        </div>
