...
<body>
  <div class="container">
    ...
    <div class="py-2">
      <form action="order_search.php" method="get">
        <div class="form-floating">
          <input type="text" name="search" class="form-control" id="floatingInput" placeholder="text">
          <label for="floatingInput">搜尋訂單編號或訂購人</label>
    ...
    <div class="py-2 d-flex justify-content-end align-items-center">
      ...
      <div class="btn-group">
        <a href="user_order.php?page=<?= $page ?>&order=1" class="btn btn-info <?php if ($order === 1) echo "active" ?>">id <i class="fa-solid fa-arrow-down-short-wide"></i></a>
        <a href="user_order.php?page=<?= $page ?>&order=2" class="btn btn-info <?php if ($order === 2) echo "active" ?>">id <i class="fa-solid fa-arrow-up-short-wide"></i></a>
        <a href="user_order.php?page=<?= $page ?>&order=3" class="btn btn-info <?php if ($order === 3) echo "active" ?>">name <i class="fa-solid fa-arrow-down-short-wide"></i></a>
        <a href="user_order.php?page=<?= $page ?>&order=4" class="btn btn-info <?php if ($order === 4) echo "active" ?>">name <i class="fa-solid fa-arrow-up-short-wide"></i></a>
      </div>
    </div>
    <div class="py-2">
