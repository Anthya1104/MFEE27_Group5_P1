      ...
      <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="row col-4">
          ...
          <div class="col-12 main-box">
            <form action="factory_signup_end.php" method="post" enctype="multipart/form-data" id="form0">

              <div class="form-row pl-2">

               <h3 class="col-12">廠商註冊</h3>
                <div class="form-group col-12">
                  <label class="font-weight-bold required">公司名稱</label>
                  <input type="text"  class="form-control form-control-lg" req="Y" title="Name" placeholder="請輸入公司名稱" name="title" value="">
                </div>
				        <div class="form-group col-12">
                  <label class="font-weight-bold required">Email</label>
                  <input type="text"  class="form-control form-control-lg" req="Y" title="Email" placeholder="test123456@gmail.com" name="email"  >
                </div>
                <div class="form-group col-12">
                  <label class="font-weight-bold required">電話</label>
                  <input type="tel"  class="form-control form-control-lg" req="Y" title="Mobile" placeholder="02-12345678" inputmode="tel" name="tel"  value="" >
                </div>
				        <div class="form-group col-12">
                  <label class="font-weight-bold required">地址</label>
                  <input type="text"  class="form-control form-control-lg" req="Y" title="地址" placeholder="請輸入地址" name="address"  >
                </div>
                <div class="form-group col-12">
