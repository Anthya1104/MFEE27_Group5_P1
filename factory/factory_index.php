              ...
              <div class="form-row pl-2">
               ...
               <h3 class="col-12">廠商修改資料</h3>
                <div class="form-group col-12">
                  ...
                  <input type="text"  class="form-control form-control-lg" req="Y" title="Name" placeholder="請輸入公司名稱" name="title" value="<?php echo $row["title"]?>">
                </div>
				      <div class="form-group col-12">
               ...
               <div class="form-group col-12">
                  ...
                  <input type="tel"  class="form-control form-control-lg" req="Y" title="Mobile" placeholder="02-12345678" inputmode="tel" name="tel"  value="<?php echo $row["tel"]?>" >
                </div>

				<div class="form-group col-12">
                  <label class="font-weight-bold required">地址</label>
                  <input type="text"  class="form-control form-control-lg" req="Y" title="地址" placeholder="請輸入地址" name="address"  value="<?php echo $row["address"]?>">
                </div>
