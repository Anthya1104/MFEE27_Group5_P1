...
if(!isset($_GET["search"])){
  ...
  // $search=$_GET["search"];
  // $sql="SELECT book_sn, book_name, book_category,price, status, upload_time FROM product WHERE book_category LIKE '%$search%'";
  ...
  JOIN category ON product.book_category = category.category_id WHERE book_category LIKE '%$search%' AND valid=1";
  $result = $conn->query($sql);
  $productCount=$result->num_rows;
  $rows = $result->fetch_all(MYSQLI_ASSOC);
  ...
  <body>
     <div class="container-fluid">
       ...
       <div class="row">
        ...
        <div class="py-2">
            <form action="search-productCategory.php" method="get">
            <div class="input-group">
                <span class=" d-flex align-items-center"></span>
                <input type="text" class="form-control rounded-start" name="search" placeholder="依產品類型搜尋">
