              ...
              <div class="form-row pl-2">
               ...
               <h3 class="col-12">廠商註冊</h3>
                <div class="form-group col-6">
                  ...
                  <input type="text"  class="form-control form-control-lg" req="Y" title="Name" placeholder="公司名稱" name="title" value="">
                </div>
				      <div class="form-group col-6">
               ...
               <div class="form-group col-6">
                  ...
                  <input type="tel"  class="form-control form-control-lg" req="Y" title="Mobile" placeholder="0912345678" inputmode="tel" name="tel"  value="" >
                </div>

				        <div class="form-group col-6">
                  <label class="font-weight-bold required">地址</label>
                  <input type="text"  class="form-control form-control-lg" req="Y" title="地址" placeholder="地址" name="address"  >
                </div>
