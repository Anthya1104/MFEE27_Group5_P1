        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="py-2 mt-4">
                    <div class="me-2 mt-2 ">
                        <h2 class="title">          
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" line-height="34" fill="currentColor" class="bi bi-bag-fill" viewBox="0 0 16 16">
          <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z"/>
          </svg>閱閱出版社&nbsp商品管理</h2>
                    </div>
                            ...
                            <div class="py-2 me-4">
                                <form action="../product-search/search-productsn.php" method="get">
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-dark thead-col"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-2 align-self-end ps-1">
                                    <div class="form-group ">
                                        ...
                                        <button type="submit" class="btn btn-dark thead-col"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                            </svg></button>
                                    </div>
                                </div>
