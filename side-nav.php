  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white position-fixed vh-100" style="width:300px; background:#102e2ef8;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/MFEE27_Group5_P1/factory/factory_index.php" class="nav-link text-white fs-5">
      ...
      <li>
        <a href="/MFEE27_Group5_P1/product-create/product-list.php" class="nav-link text-white fs-5">
      ...
      <li>
        <a href="/MFEE27_Group5_P1/order_system/user_order.php" class="nav-link text-white fs-5">
      ...
      <hr>
      <li>
        <a href="/MFEE27_Group5_P1/member-comment/comment-list.php" class="nav-link text-white fs-5">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
