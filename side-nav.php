  ...
  <div class="position-relative d-flex flex-column flex-shrink-0 p-3 text-white position-fixed vh-100" style="width:300px; background:#102e2ef8;">
    ...
    <ul class="nav nav-pills flex-column mb-auto" style="margin-top:150px;">
      <li class="nav-item">
        <a href="/MFEE27_Group5_P1/dashboard/" class="nav-link text-white" style="font-size:20px">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
      ...
      <li>
        <a href="/MFEE27_Group5_P1/coupon/coupon-list.php" class="nav-link text-white" style="font-size:20px">
      ...
      <hr>
      <li>
        <a href="/MFEE27_Group5_P1/entrance.html" class="nav-link text-white" style="font-size:20px">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
